...
def dash_plot1():
    return html.Div(
        [
            dcc.Graph(id="histogram", figure=no_bg(age_gender_historgram())),
        ]
    )
...
def seasonal_pie():
    return html.Div(
        [
            dcc.Graph(id="season-pie", figure=season_participation()),
        ]
    )
...
def sport_participation():
    fig = px.scatter(
        ...
        size="Year",
        hover_data=["Year"],
        title="How many years a is year.., lol sry.",
    )
    return fig
    ...
    return html.Div(
        [
            html.Div(
                ...
                children=[
                    dbc.Row([dbc.Col(html.H1(title + ": " + (region + " " + flag)))])
                ],
            )
        ]
    )
...
def info_box(title=None, paragraph=None, css_class=None):
    return html.Div(
        ...
        children=[
            dbc.Row(
                [html.H2(title), html.P(paragraph)],
                justify="center",
                align="center",
                className="h-50",
            )
...
def search_country(css_class=None):
    return html.Div(
        [
            ...
            html.Div(id="country-select-output"),
        ],
        className=css_class,
    )
        ...
        [
            ...
            dbc.Row(
                [
                    ...
                    dbc.Col(html.Div(xcs_men_test()), md=6)
                ]
            ),
            #dbc.Row([dbc.Col(html.Div(xcs_men_test()), md=6)]),
...
def regex_filter(value):  # Function to predict country from user input keys
    ...
    if len(filtered_list) > 0:
        ...
        return "No country found: Did you mean: 'suggested value'"  # TODO
...
def flag_algo(selected_region):
    ...
    if selected_region == "Germany":
        ...
        return "\U0001F3AF"  # Placeholder emoji
...
if __name__ == "__main__":
    ...
    app.layout = html.Div(
        [
            ...
            info_box(
                "Olympic Games. Visualised through trial and error.",
            ...
            info_box(
                (("All countries " + "\U0001F30E")), "Sport specific", "olympic-act1"
            ),
            div2(),
